...
def main():
    ctvol_path = Path('/home/andyding/tbone-seg-nnunetv2/niftis/Segmentation_LT_152.nii.gz')
    ctvol_ref_path = Path('/home/andyding/tbone-seg-nnunetv2/niftis/LT_152.nii.gz')
    out_path = Path('/home/andyding/tbone-seg-nnunetv2/niftis/Segmentation_LT_152.nii.gz')
    desired_spacing = [0.09797599911689758, 0.09796378761529922, 0.09797599911689758]
    resample_volume_from_reference(ctvol_path, ctvol_ref_path, out_path, verbose = True)
